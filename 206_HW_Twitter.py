...
CACHE_FNAME = 'twitter_cache.json' #creating cache json file

try:
    cache_file = open(CACHE_FNAME, 'r') #try reading data from file
    cache_information = cache_file.read()  #put data from file into a string
